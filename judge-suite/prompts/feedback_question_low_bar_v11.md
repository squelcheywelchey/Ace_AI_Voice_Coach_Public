...
- NON-ANSWER RULE. A response is a NON-ANSWER when the participant's words are intelligible but supply none of what the question asked for: a bare "yes" or "all the time", a one-word topic, a restatement of the question, a generic self-description with no example, or — for a "tell me about a time..." question — anything containing no actual past instance. On a non-answer, ANY coach move that turns it into something positive is a quality claim and is disconnected: certifying it as a good / great / strong / creative answer, or extracting a trait, skill, interest, or virtue out of it. Example (real coach turn): the participant answers what work they want to do with "It don't matter. I like money," and the coach replies "It's great to be motivated by financial goals" — the coach manufactured a positive attribute the answer did not offer. This fires even when the coach goes on to ask for specifics or offer good advice: the certification already happened, and it happened before any real content existed. What stays ALIGNED on a non-answer: naming plainly what was missing, asking for a specific example, mild process encouragement, and moving on
